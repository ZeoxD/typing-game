    ...
    CYAN_FG ascii_art("        TYPING  GAME"); cout<<endl;
        ...
        for(int i = 0; i < WINDOW_HEIGHT; i++)
        {
                for (int j =0; j < WINDOW_WIDTH; j++)
                {
                    ...
                    {
                        BLUE_BG cout<<"  "; WHITE_BG RED_FG cout<<"  1.START  "; BLACK_FG BLUE_BG cout<<"  "; BLACK_BG
                    }

                    else if( i==11 AND j==(WINDOW_WIDTH/2)-4 )
                    {
                        BLUE_BG cout<<"  "; WHITE_BG RED_FG cout<<"  2.ABOUT  "; BLACK_FG BLUE_BG cout<<"  "; BLACK_BG
                    }

                    else if( i==13 AND j==(WINDOW_WIDTH/2)-4 )
                    {
                        BLUE_BG cout<<"  "; WHITE_BG RED_FG cout<<"  3.EXIT   "; BLACK_FG BLUE_BG cout<<"  "; BLACK_BG
                    }
